...
/**
 * A [[CustomFunction4]] represents a Google custom function taking 4 inputs and returning an [[Output]].
 *
...
object CustomFunction4 {
 ...
 (implicit
  ...
  encoder3: Encoder[T3],
  encoder4: Encoder[T4],
 decoder: Decoder[U]): CustomFunction4[T1, T2, T3, T4, U] =
