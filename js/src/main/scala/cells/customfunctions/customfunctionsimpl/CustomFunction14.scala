...
/**
 * A [[CustomFunction14]] represents a Google custom function taking 14 inputs and returning an [[Output]].
 *
...
decoder: Decoder[U])
extends ((Input, Input, Input, Input, Input, Input, Input, Input, Input, Input, Input, Input, Input, Input) => Output) {

 def apply(input1: Input, input2: Input, input3: Input, input4: Input, input5: Input, input6: Input, input7: Input, input8: Input, input9: Input, input10: Input, input11: Input, input12: Input, input13: Input, input14: Input): Output = {
 (
 for {
 ...
 output = f(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14)
...
object CustomFunction14 {

 def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, U]
 (f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14) => U)
 (implicit
  encoder1: Encoder[T1],
  encoder2: Encoder[T2],
  ...
  encoder13: Encoder[T13],
  encoder14: Encoder[T14],
 decoder: Decoder[U]): CustomFunction14[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, U] =
 new CustomFunction14(f)

  implicit final class FromFunction14[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, -T9, -T10, -T11, -T12, -T13, -T14, +U](
    f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14) => U
  )
  (implicit
  encoder1: Encoder[T1],
  ...
  encoder14: Encoder[T14],
  decoder: Decoder[U]) {
  def asCustomFunction: CustomFunction14[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, U] = CustomFunction14(f)
  }
