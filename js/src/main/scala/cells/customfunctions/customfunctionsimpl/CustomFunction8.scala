...
/**
 * A [[CustomFunction8]] represents a Google custom function taking 8 inputs and returning an [[Output]].
 *
...
encoder8: Encoder[T8],
decoder: Decoder[U])
extends ((Input, Input, Input, Input, Input, Input, Input, Input) => Output) {

 def apply(input1: Input, input2: Input, input3: Input, input4: Input, input5: Input, input6: Input, input7: Input, input8: Input): Output = {
 (
 for {
...
object CustomFunction8 {
 ...
 (implicit
  ...
  encoder7: Encoder[T7],
  encoder8: Encoder[T8],
 decoder: Decoder[U]): CustomFunction8[T1, T2, T3, T4, T5, T6, T7, T8, U] =
 new CustomFunction8(f)
  ...
  encoder8: Encoder[T8],
  decoder: Decoder[U]) {
  def asCustomFunction: CustomFunction8[T1, T2, T3, T4, T5, T6, T7, T8, U] = CustomFunction8(f)
  }
