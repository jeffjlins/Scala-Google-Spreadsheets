...
/**
 * A [[CustomFunction9]] represents a Google custom function taking 9 inputs and returning an [[Output]].
 *
...
extends ((Input, Input, Input, Input, Input, Input, Input, Input, Input) => Output) {
 ...
 def apply(input1: Input, input2: Input, input3: Input, input4: Input, input5: Input, input6: Input, input7: Input, input8: Input, input9: Input): Output = {
 (
 for {
 ...
 output = f(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
...
object CustomFunction9 {
 ...
 (implicit
  ...
  encoder8: Encoder[T8],
  encoder9: Encoder[T9],
 decoder: Decoder[U]): CustomFunction9[T1, T2, T3, T4, T5, T6, T7, T8, T9, U] =
 new CustomFunction9(f)
  ...
  encoder9: Encoder[T9],
  decoder: Decoder[U]) {
  def asCustomFunction: CustomFunction9[T1, T2, T3, T4, T5, T6, T7, T8, T9, U] = CustomFunction9(f)
  }
