...
/**
 * A [[CustomFunction11]] represents a Google custom function taking 11 inputs and returning an [[Output]].
 *
...
decoder: Decoder[U])
extends ((Input, Input, Input, Input, Input, Input, Input, Input, Input, Input, Input) => Output) {

 def apply(input1: Input, input2: Input, input3: Input, input4: Input, input5: Input, input6: Input, input7: Input, input8: Input, input9: Input, input10: Input, input11: Input): Output = {
 (
 for {
 ...
 output = f(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11)
...
object CustomFunction11 {

 def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, U]
 (f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) => U)
 (implicit
  encoder1: Encoder[T1],
  encoder2: Encoder[T2],
  ...
  encoder10: Encoder[T10],
  encoder11: Encoder[T11],
 decoder: Decoder[U]): CustomFunction11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, U] =
 new CustomFunction11(f)

  implicit final class FromFunction11[-T1, -T2, -T3, -T4, -T5, -T6, -T7, -T8, -T9, -T10, -T11, +U](
    f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) => U
  )
  (implicit
  encoder1: Encoder[T1],
  ...
  encoder11: Encoder[T11],
  decoder: Decoder[U]) {
  def asCustomFunction: CustomFunction11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, U] = CustomFunction11(f)
  }
